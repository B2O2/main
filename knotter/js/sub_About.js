...
window.addEventListener("scroll", function () {
  ...
  if (value > 300) {
    ...
    on1.style.animation = "movLeft 0.25s forwards";
    on2.style.animation = "movLeft 0.4s forwards";
    on3.style.animation = "movLeft 0.55s forwards";
    on4.style.animation = "movLeft 0.7s forwards";
    on5.style.animation = "movLeft 0.85s forwards";
...
window.addEventListener("scroll", function () {
  ...
  if (value > 5600) {
    ...
    eng.style.animation = "fadeIn 5s forwards";
  }
